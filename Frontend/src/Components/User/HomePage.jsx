...
function Home() {
  ...
  useEffect(()=>{
      const fetchFavCountries=async()=>{
        try{
          ...
          const response = await axios.get(`${import.meta.env.VITE_BACKEND_URL}/api/country/get-favourite-country`,{
  ...
  const toggleFavourite = async (countryCode, countryName) => {
    ...
    try {
      if (isAlreadyFav) {
        await axios.delete(`${import.meta.env.VITE_BACKEND_URL}/api/country/delete-fav-country`, {
          data: { countryCode },
          withCredentials: true
        });
        ...
        await axios.post(`${import.meta.env.VITE_BACKEND_URL}/api/country/add-favourite-country`, {
          countryName,
          countryCode
        }, { withCredentials: true });
